clearvars
close all
load('Data/Cells/ProcessedData/MDAMB231/Tdata1.mat','tracks','tracksColHeaders')
...
% grid on
%     saveas(f1, ['E:\Work\MdaMB231_NegativeQDFExperiment\DPCImages\MassPerAreaVsDF.svg'])
...
% Plot fit with data.
% figure( 'Name', 'untitled fit 1' );
% h = plot( fitresult3a, xData3a, yData3a );
% legend( h, 'cleanMeanDF vs. cleanMeanMass', 'untitled fit 1', 'Location', 'NorthEast', 'Interpreter', 'none' );
% Label axes
% xlabel( 'cleanMeanMass', 'Interpreter', 'none' );
% ylabel( 'cleanMeanDF', 'Interpreter', 'none' );
% grid on
...
% Plot fit with data.
% figure( 'Name', 'untitled fit 1' );
% h = plot( fitresult3b, xData3b, yData3b );
% legend( h, 'cleanMeanQDF vs. cleanMeanMass', 'untitled fit 1', 'Location', 'NorthEast', 'Interpreter', 'none' );
% Label axes
% xlabel( 'cleanMeanMass', 'Interpreter', 'none' );
% ylabel( 'cleanMeanQDF', 'Interpreter', 'none' );
% grid on
%     saveas(f3, ['E:\Work\MdaMB231_NegativeQDFExperiment\DPCImages\MassPerAreaVsDFPerArea.svg'])
...
% %% figure 2 Mass per Area vs DF/QDF per mass
% 
% [xData2a, yData2a] = prepareCurveData( cleanMeanMass, cleanDF );
% 
% % Set up fittype and options.
% ft2a = fittype( 'poly1' );
% 
...
% % hold on
% 
% xlabel( 'Mass (pg)', 'Interpreter', 'tex' );
% 
% % figure( 'Name', 'untitled fit 1' );
% % h = plot( fitresult2a, xData2a, yData2a );
% % legend( h, 'cleanDFPerMass vs. cleanMeanMass', 'untitled fit 1', 'Location', 'NorthEast', 'Interpreter', 'none' );
...
% % grid on
% 
% [xData2b, yData2b] = prepareCurveData( cleanMass, cleanQDF );
% 
% % Set up fittype and options.
% ft2b = fittype( 'poly1' );
% 
