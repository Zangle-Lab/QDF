function [ D2, L, L_tight, M,DF,CorrDF] = LoadSegment_CFit_mdamb231_darkfield_v2( fname, fname2, wavelength, Btotal, AverageEmptyTL, AverageEmptyTR,AverageEmptyBR, AverageEmptyBL,order, polyfitReductionParams)
...
[L,L_tight] = imagesegment_aggressive_MDA_DF_v2(DF1); %segment image (detect distinct cell regions and disconnect connected regions)
